...
namespace Web.Api.Migrations
{
    ...
    [Migration("20250204161840_AddCarritoItems")]
    partial class AddCarritoItems
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Model.Entity.CarritoItem", b =>
                {
            ...
            modelBuilder.Entity("Model.Entity.ProductoImagen", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Model.Entity.CarritoItem", b =>
                {
                    b.HasOne("Model.Entity.Producto", "Producto")
                        .WithOne()
                        .HasForeignKey("Model.Entity.CarritoItem", "ProductoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.OwnsOne("Model.Entity.UsuarioImagen", "Imagen", b1 =>
                        {
                            ...
                            b1.Property<string>("FotoPerfilKey")
                                .IsRequired()
                                .HasMaxLength(64)
